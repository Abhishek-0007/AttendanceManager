...
public class Register extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText password;
    Button mRegisterbtn;
    RadioButton teacherAvatar,studentAvatar;
    String avatar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teacherAvatar = (RadioButton)findViewById(R.id.teacher);
        studentAvatar = (RadioButton) findViewById(R.id.student);
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                if(teacherAvatar.isChecked()){
                    avatar = "Teacher";
                }
                if(studentAvatar.isChecked()){
                    avatar = "Student";
                }
            }
        });
